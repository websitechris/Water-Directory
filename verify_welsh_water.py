#!/usr/bin/env python3
"""Verify Welsh Water upload: postcodes.io → LSOA → Supabase lookup."""
import json
...
def main():
    # CF10 1AA LSOA W01002019 may not be in dataset; try CF10 1AA then CF11 8AA (Cardiff)
    for postcode in ["CF10 1AA", "CF11 8AA"]:
        ...
        print("\n✅ Welsh Water upload verified")
        return
    print("\n❌ No Welsh Water zone found for Cardiff postcodes")
