#!/usr/bin/env python3
"""Verify Northumbrian Water upload: postcodes.io → LSOA → Supabase lookup."""
import json
...
def main():
    # NE1 1AA is terminated; using NE1 1AD (Newcastle)
    postcode = "NE1 1AD"
    print("Note: NE1 1AA is terminated; verifying with NE1 1AD (Newcastle).\n")
    ...
    print("\n✅ Northumbrian Water upload verified" if readings else "\n❌ No chemical readings found")
