#!/usr/bin/env python3
"""Verify United Utilities upload: postcodes.io → LSOA → Supabase lookup."""
import json
...
def main():
    # M1 1AA is terminated; using M1 1AD (Manchester)
    postcode = "M1 1AD"
    print("Note: M1 1AA is terminated; verifying with M1 1AD (Manchester).\n")
    ...
    print("\n✅ United Utilities upload verified" if readings else "\n❌ No chemical readings found")
