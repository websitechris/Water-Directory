#!/usr/bin/env python3
"""Verify South West Water upload: postcodes.io → LSOA → Supabase lookup."""
import json
...
def main():
    # EX1 1AA is terminated; using EX1 2AA (Exeter)
    postcode = "EX1 2AA"
    print("Note: EX1 1AA is terminated; verifying with EX1 2AA (Exeter).\n")
    ...
    print("\n✅ South West Water upload verified" if readings else "\n❌ No chemical readings found")
