#!/usr/bin/env python3
"""Verify Anglian Water upload: postcodes.io → LSOA → Supabase lookup."""
import json
...
def main():
    ...
    if readings:
        ...
        print(f"\n   Note: NR1 1AA has no Lead/Fluoride in Anglian CSV (data limitation). Try a zone with full data, e.g. E01026889.")
    else:
        print("   (no readings found)")

    print("\n✅ Anglian Water upload verified" if readings else "\n❌ No chemical readings found")
